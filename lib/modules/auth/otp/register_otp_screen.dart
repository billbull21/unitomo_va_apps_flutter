...
class _RegisterOtpScreenState extends ConsumerState<RegisterOtpScreen> {
  ...
  void initState() {
    super.initState();
    final userProvider = ref.read(providerUser.notifier);
    _userModel = userProvider.state;
  }
  ...
  void _verifyOtp() async {
    ...
    if (_otpValues.where((e) => e.trim().isEmpty).isEmpty) {
      try {
        ...
        final response =
            await apiProvider.verificationRegister(_otpValues.join(""));
  ...
  void _resendOTP() async {
    ...
    try {
      final apiProvider = ApiProvider();
      final response = await apiProvider.resendOtp();
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          const TextSpan(
                            text: ". Silahkan cek inbox atau spam pada email Anda!",
                          )
                        ],
